...
Ниже собраны основные документы проекта и их назначение.

| Документ | Файл |
| --- | --- |
| Устав проекта | [docs/00_Governance/P1_Project_Charter.md](./00_Governance/P1_Project_Charter.md) |
| Матрица рисков | [docs/00_Governance/P2_Risk_Matrix.md](./00_Governance/P2_Risk_Matrix.md) |
| Протоколы ключевых командных встреч | [docs/00_Governance/P3_Key_Meeting_Minutes.md](./00_Governance/P3_Key_Meeting_Minutes.md) |
...
- [Карточка проекта](./01_Project_Launch/P1_Project_Card.md)
- [WBS](./01_Project_Launch/P2_WBS.md)
